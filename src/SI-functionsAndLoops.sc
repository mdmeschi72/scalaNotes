...
// you can define a function in scala with a variable number of arguments
...
// you cannot pass in the 1.to(10) to function with variable
// arguments because scala is so strongly typecast
